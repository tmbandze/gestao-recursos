...
public class GestorLivros {
    ...
    public synchronized Map<String, Object> inserir(String titulo, String autor, String categoria, String nome) {
        ...
        livros.add(new Livro(id, titulo.trim(), autor.trim(), categoria.trim()));
